...
//
//  =====================================================================
func Zsymm(side *byte, uplo *byte, m *int, n *int, alpha *complex128, a *[]complex128, aoff, lda *int, b *[]complex128, boff, ldb *int, beta *complex128, c *[]complex128, coff, ldc *int) {
	var upper bool
