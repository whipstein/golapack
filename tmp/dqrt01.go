...
//          The test ratios:
//          result1 = norm( R - Q'*A) / ( m * norm(a) * eps)
...
//
//  =====================================================================
func Dqrt01(m *int, n *int, a *[][]float64, af *[][]float64, q *[][]float64, r *[][]float64, lda *int, tau *[]float64, work *[]float64, lwork *int, rwork *[]float64, result *[]float64) {
	zero := new(float64)
	one := new(float64)
	rogue := new(float64)
	info := new(int)
