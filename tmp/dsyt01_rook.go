...
// Dsyt01Rook re_constructs a symmetric indefinite matrix A from its
...
//  ===========
//
//       SUBROUTinE Dsyt01Rook( uplo, n, a, lda, afac, ldafac, ipiv, c, ldc,
//                          rwork, resid)
//
//       .. Scalar Arguments ..
//       CHARACTER          uplo
...
//          The pivot indices from DsytrfRook.
// \endverbatim
//
// \param[out] C
// \verbatim
...
//
//  =====================================================================
func Dsyt01Rook(uplo *byte, n *int, a *[][]float64, lda *int, afac *[][]float64, ldafac *int, ipiv *[]int, c *[][]float64, ldc *int, rwork *[]float64, resid *float64) {
	zero := new(float64)
	one := new(float64)
	i := new(int)
	info := new(int)
