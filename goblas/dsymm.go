...
//
//  =====================================================================
func Dsymm(major, side, uplo *byte, m, n *int, alpha *float64, a *[][]float64, lda *int, b *[][]float64, ldb *int, beta *float64, c *[][]float64, ldc *int) {
	...
	if info != 0 {
		Xerbla(func() *string { y := "Dsymm"; return &y }(), &info)
		return
	}
	//
