...
//
//  =====================================================================
func Ctrsm(major, side, uplo, transa, diag *byte, m, n *int, alpha *complex64, a *[][]complex64, lda *int, b *[][]complex64, ldb *int) {
	var temp complex64
				...
				for k = *n; k >= 1; k-- {
					if nounit {
						if noconj {
							...
							temp = 1.0 / complex64(cmplx.Conj(complex128((*a)[k-1][k-1])))
						}
						for i = 1; i <= *m; i++ {
					...
					for j = 1; j <= k-1; j++ {
						if (*a)[j-1][k-1] != 0.0 {
							if noconj {
								...
								temp = complex64(cmplx.Conj(complex128((*a)[j-1][k-1])))
							}
							for i = 1; i <= *m; i++ {
