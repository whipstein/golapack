...
//
//  =====================================================================
func Dsyr2k(major, uplo, trans *byte, n, k *int, alpha *float64, a *[][]float64, lda *int, b *[][]float64, ldb *int, beta *float64, c *[][]float64, ldc *int) {
	...
	if info != 0 {
		Xerbla(func() *string { y := "Dsyr2k"; return &y }(), &info)
		return
	}
	//
