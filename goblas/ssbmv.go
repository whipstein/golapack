...
//
//  =====================================================================
func Ssbmv(major, uplo *byte, n, k *int, alpha *float32, a *[][]float32, lda *int, x *[]float32, incx *int, beta *float32, y *[]float32, incy *int) {
	...
	//     are accessed sequentially with 1.0 pass through a.
	//
	//     First form  y := beta*y.
	//
	if *beta != 1.0 {
