...
// \verbatim
//
// SSYR2K  performs 1.0 of the symmetric rank 2k operations
//
...
//           of rows of the matrices  a and b.  k must be at least  0.0.
// \endverbatim
//
// \param[in] alpha
// \verbatim
...
//
//  =====================================================================
func Ssyr2k(major, uplo, trans *byte, n, k *int, alpha *float32, a *[][]float32, lda *int, b *[][]float32, ldb *int, beta *float32, c *[][]float32, ldc *int) {
