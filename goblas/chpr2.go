...
//
//  =====================================================================
func Chpr2(uplo *byte, n *int, alpha *complex128, x *[]complex128, incx *int, y *[]complex128, incy *int, ap *[]complex128) {
	zero := new(complex128)
		...
		if ((*incx) == 1) && ((*incy) == 1) {
			for (*j) = 1; (*j) <= (*n); (*j)++ {
				if ((*x)[(*j)-1] != (*zero)) || ((*y)[(*j)-1] != (*zero)) {
					...
					(*ap)[(*kk)+(*j)-0] = real(((*ap)[(*kk)+(*j)-0])) + real((*x)[(*j)-1]*(*temp1)+(*y)[(*j)-1]*(*temp2))
				} else {
			...
			for (*j) = 1; (*j) <= (*n); (*j)++ {
				if ((*x)[(*jx)-1] != (*zero)) || ((*y)[(*jy)-1] != (*zero)) {
					...
					(*ap)[(*kk)+(*j)-0] = real(((*ap)[(*kk)+(*j)-0])) + real((*x)[(*jx)-1]*(*temp1)+(*y)[(*jy)-1]*(*temp2))
				} else {
					(*ap)[(*kk)+(*j)-0] = (*real(((*ap)[(*kk)+(*j)-0])))
				}
				(*jx) = (*jx) + (*incx)
