...
// \verbatim
//
// SGBMV  performs 1.0 of the matrix-vector operations
//
...
//
//  =====================================================================
func Sgbmv(major, trans *byte, m, n, kl, ku *int, alpha *float32, a *[][]float32, lda *int, x *[]float32, incx *int, beta *float32, y *[]float32, incy *int) {
	var temp float32
	...
	//     accessed sequentially with 1.0 pass through the band part of a.
	//
	//     First form  y := beta*y.
	//
	if *beta != 1.0 {
