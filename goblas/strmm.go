...
// \verbatim
//
// STRMM  performs 1.0 of the matrix-matrix operations
//
...
//
//  =====================================================================
func Strmm(major, side, uplo, transa, diag *byte, m, n *int, alpha *float32, a *[][]float32, lda *int, b *[][]float32, ldb *int) {
	var temp float32
