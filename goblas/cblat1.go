...
func Header() {
	...
	*icase = *common.combla.icase
	//*     .. Data statements ..
	(*l)[0][0], (*l)[1][0], (*l)[2][0], (*l)[3][0], (*l)[4][0], (*l)[5][0] = 'c', 'd', 'o', 't', 'c', ' '
	(*l)[0][1], (*l)[1][1], (*l)[2][1], (*l)[3][1], (*l)[4][1], (*l)[5][1] = 'c', 'd', 'o', 't', 'u', ' '
	(*l)[0][2], (*l)[1][2], (*l)[2][2], (*l)[3][2], (*l)[4][2], (*l)[5][2] = 'c', 'a', 'x', 'p', 'y', ' '
	(*l)[0][3], (*l)[1][3], (*l)[2][3], (*l)[3][3], (*l)[4][3], (*l)[5][3] = 'c', 'c', 'o', 'p', 'y', ' '
	(*l)[0][4], (*l)[1][4], (*l)[2][4], (*l)[3][4], (*l)[4][4], (*l)[5][4] = 'c', 's', 'w', 'a', 'p', ' '
	(*l)[0][5], (*l)[1][5], (*l)[2][5], (*l)[3][5], (*l)[4][5], (*l)[5][5] = 's', 'c', 'n', 'r', 'm', '2'
	(*l)[0][6], (*l)[1][6], (*l)[2][6], (*l)[3][6], (*l)[4][6], (*l)[5][6] = 's', 'c', 'a', 's', 'u', 'm'
	(*l)[0][7], (*l)[1][7], (*l)[2][7], (*l)[3][7], (*l)[4][7], (*l)[5][7] = 'c', 's', 'c', 'a', 'l', ' '
	(*l)[0][8], (*l)[1][8], (*l)[2][8], (*l)[3][8], (*l)[4][8], (*l)[5][8] = 'c', 's', 's', 'c', 'a', 'l'
	(*l)[0][9], (*l)[1][9], (*l)[2][9], (*l)[3][9], (*l)[4][9], (*l)[5][9] = 'i', 'c', 'a', 'm', 'a', 'x'
	//*     .. Executable Statements ..
...
func Check1(sfac *float64) {
	...
	for (*incx) = 1; (*incx) <= 2; (*incx)++ {
		for (*np1) = 1; (*np1) <= 5; (*np1)++ {
			...
			if (*icase) == 6 {
				//*              .. Scnrm2 ..
				Stest1(Scnrm2(n, cx, incx), &((*strue2)[(*np1)-1]), &((*strue2)[(*np1)-1]), sfac)
			} else if (*icase) == 7 {
				//*              .. Scasum ..
				Stest1(Scasum(n, cx, incx), &((*strue4)[(*np1)-1]), &((*strue4)[(*np1)-1]), sfac)
			} else if (*icase) == 8 {
				//*              .. Cscal ..
				Cscal(n, ca, cx, incx)
				...
				//*              .. Icamax ..
				Itest1(Icamax(n, cx, incx), &((*itrue3)[(*np1)-1]))
			} else {
	...
	if (*icase) == 8 {
		...
		Cscal(func() *int { y := 5; return &y }(), ca, cx, incx)
		...
		Csscal(func() *int { y := 5; return &y }(), sa, cx, incx)
		Ctest(func() *int { y := 5; return &y }(), cx, mwpct, mwpcs, sfac)
...
func Stest(_len *int, scomp *[]float64, strue *[]float64, ssize *[]float64, sfac *float64) {
	...
	for (*i) = 1; (*i) <= (*len); (*i)++ {
		...
		if math.Abs((*sfac)*(*sd)) <= math.Abs((*ssize)[(*i)-1])*EPSILON(*zero) {
			goto Label40
		}
		if !(*pass) {
			goto Label20
